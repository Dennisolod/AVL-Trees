...
public class AVLTest {
    ...
    private static void treeEquals(
        ...
        assertEquals(preOrder(a.root), preo);
        assertEquals(inOrder(a.root), ino);
        assertEquals(postOrder(a.root), posto);
    ...
    public void test00bstInsertRoot() {
        ...
        assertNull(a.root.parent);
        assertNull(a.root.left);
        assertNull(a.root.right);
    }
